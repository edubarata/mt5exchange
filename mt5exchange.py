...
class MTrader():
    ...
    def read_candles_mt5(self,symbol,tf,n=1,time_index=False):
        # symbol = 'PETR4'
        # tf = '1m' / '5m' / '1h' / '1d' / ...
        # n = 0 (opened candle)
        ...
        #print('antes do erro 2:',symbol,timef,n)
        #print(df)
    ...
    def read_candles(self,symbol,tf,n=0,verbose=False):
    ...
    def create_df_file(symbol,tf,n,filename):
        df = read_candles_mt5(symbol,tf,n)
        df.to_csv(filename)

    def get_book(self,ativo,data_inicio,n=1000):
        '''
